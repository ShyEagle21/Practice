...
###########################################################################################
    ...
    pivot_table['pkg_inducted_utc_ts_cum'] = pivot_table['pkg_inducted_utc_ts'].cumsum()
 
    pivot_table['Inducted'] = pivot_table['pkg_inducted_utc_ts_cum'] 
    ...
    for day, group in pivot_table.groupby('custom_day'):
        ...
        group['pkg_inducted_utc_ts_cum'] = group['pkg_inducted_utc_ts'].cumsum() 
        ...
        daily_dic[day] = pkg_inducted_utc_ts_cum
